...
xmlhttp.open("GET","lookup.php",true);
xmlhttp.send();
}
</script>
 ...
 <body onload="disp()" style=" background-image: url(images/bgadmin2.jpg); background-repeat:no-repeat; background-size:cover;  font-size:16px;font-family:Arial;color:white;">
  ...
  <center>
<center>
 <br><br><h4 class="my-2" align="center"style=" font-family:Arial ;width:400px;box-shadow: 3px 2px 3px 2px black;color :white;background-color:rgb(196, 25, 25 ,0.7) ;border-radius: 15px;"><b style="text-shadow: 3px 2px black;">Student IA General Details</b></h4>
