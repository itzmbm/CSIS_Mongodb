...
<script>
function getData() {
	str=document.getElementById("usn").value;           
...
xmlhttp.open("GET","studentdetails.php?q="+str,true);
xmlhttp.send();
         }
function disp(){
...
xmlhttp.open("GET","studentdetailsonload.php",true);
xmlhttp.send();
}
</script>
 ...
 <body onload="disp()" style=" background-image: url(images/bgadmin2.jpg); background-repeat:no-repeat; background-size:cover;  font-size:16px;font-family:Arial;color:white;">
  ...
  <form>
  <input type="text" class="textbox" name="usn" style="margin-bottom:10px;margin-top:5;" id="usn" placeholder="Enter USN" >
