    				...
    				<div class="col-md-12">
    					<div class="row">
    						<div class="col-md-8">
    							...
    							<h5 class="my-2 text-white " style="font-size: 30px;">Assignment</h5>
    							<h5 class="my-2 text-white " style="font-size: 30px;">Given</h5>
    						</div>
							<div class="col-md-4">
    							<a href="displayassign.php" ><img src="images/atticon.png" style="border-color: rgb(224, 37, 54 ,0.0);margin-top:-20px;width:100px;opacity: 0.9;height:100px;box-shadow: -2px 2px 2px -2px black;border-radius:55px 55px;" alt="Click here"> </a>
    						</div>
