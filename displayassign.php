...
xmlhttp.open("GET","assignddetails1.php?q="+str,true);
xmlhttp.send();
         }
...
xmlhttp.open("GET","assignddetails.php",true);
xmlhttp.send();
}
</script>
 ...
 <body onload="disp()" style=" background-image: url(images/bgadmin2.jpg); background-repeat:no-repeat; background-size:cover;  font-size:16px;font-family:Arial;color:white;">
  ...
  <form>
  <input type="textbox" class="textbox" name="sub" style="margin-bottom:10px;margin-top:5;" id="sub" placeholder="Enter subject" >
